...
If you want to use it, please buy it. :) [Devot-ee](https://devot-ee.com/add-ons/feed-url)

## Documentation

[More information, how to use...](ee3x-4x/system/user/addons/feed_url/README.md)
